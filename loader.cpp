...
void Loader::on_btnLock_clicked()
{
    ...
    proc->start("tools/adb", QStringList() << "reboot-bootloader");
    ...
    {
        proc->start("tools/fastboot", QStringList() << "oem" << "lock-go");
...
void Loader::on_btnUnlock_clicked()
{
    ...
    if(msgBox->exec() == QMessageBox::Ok)
    {
        proc->start("tools/fastboot", QStringList() << "flashing" << "get_unlock_ability");
    ...
    {
        proc->start("tools/fastboot", QStringList() << "oem" << "unlock-go");
    ...
    {
        proc->start("tools/fastboot", QStringList() << "reboot");
